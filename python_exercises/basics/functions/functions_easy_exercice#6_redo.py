...
print(count_words("Jeux vidéos et débats"))
...
def count_alpha(text):
    ...
    """
    letters = "azertyuiopqsdfghjklmnbvcxwAZERTYUPMLKJHGFDSQWXCVBN"
    count = 0
    ...
    for c in text : 
        if c in letters : 
            count += 1 
    return count 
print(count_alpha("What's up braz"))
...
print(most_frequent_letter("llaaaapppppppmmmmmmmmmmwwwwwwwwwwwwwwwwww"))